...
//! # Diagnostic Strategy
//!
//! Semantic analysis produces [`Diagnostic`](spl_diagnostic::Diagnostic) errors through an
...
//!
//! Rich diagnostics are constructed using the [`Diagnostic`](spl_diagnostic::Diagnostic)
