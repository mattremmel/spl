...
//! ## Why Not Diagnostic?
//!
//! The parser uses its own [`ParseError`] type rather than a richer
//! diagnostic type for several reasons:
//!
...
//!   allocation overhead of diagnostic label vectors.
//!
//! The compiler driver can convert [`ParseError`] to a richer diagnostic type
